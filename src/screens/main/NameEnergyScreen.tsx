...
type Props = NativeStackScreenProps<RootStackParamList, 'NameEnergy'>;

export const NameEnergyScreen: React.FC<Props> = ({ navigation }) => {
    const { t } = useSettings();
    ...
    const canAnalyze = lettersOnly.length > 0;

    const handleAnalyze = () => {
        if (!canAnalyze || isCalculating) return;
        setIsCalculating(true);
        setTimeout(() => {
            const destiny = NumerologyEngine.getNameDestinyNumber(input);
            setResult(destiny);
                ...
                <View style={styles.headerRow}>
                    <View style={styles.header}>
                        ...
                        <View style={styles.headerTitleWrap}>
                            <Type color={Colors.primary} size={22} />
                    ...
                    >
                            ...
                            <GlassCard style={styles.inputCard} border>
                                <TextInput
                                    ref={inputRef}
                                    style={styles.input}
                                    placeholder={t('nameEnergyPlaceholder')}
